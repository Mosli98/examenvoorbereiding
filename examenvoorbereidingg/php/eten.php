...
$table = "<table><tr><th>eten:</th></tr>";

$conn = new MySqli('localhost', 'root', '', 'excellenttaste');
...
WHERE g.gerechtcategoriencode = '4cdd0' OR g.gerechtcategoriencode = '8286f' OR g.gerechtcategoriencode = 'b4848'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit']) && !empty($_POST['submit'])) {
    ...
    $sql = "INSERT INTO menuitems VALUES (:menuitemscode, :gerechtsoortencode, :code, :prijs, :naam)";
        ...
        $db->insert($sql, $named_placeholder, 'eten.php');
}
...
$db->edit_or_delete($sql, $named_placeholder, 'eten.php');
...
<body>
            <form action="drank.php" method="post" style="margin: 3rem 0 3rem 0;border: 1px solid black; width: 230px; text-align: center; height: 500px">           
                <h1>eten toevoegen</h1><br>
            ...
            <form action="drank.php" method="post" style="border: 1px solid black; width: 300px; text-align: center; height: 410px; float: right; margin-top: -500px">           
            <h1>Wijzig </h1><br>
            ...
            <form action="drank.php" method="post" style="border: 1px solid black; width: 300px; text-align: center; height: 240px; float: right; position: absolute; margin: 0 0 30rem 50rem;">           
