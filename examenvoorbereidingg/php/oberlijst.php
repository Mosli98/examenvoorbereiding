...
$table = "<table><tr><th>tafel</th><th>aantal</th><th>bestellingen</th></tr>";

$conn = new MySqli('localhost', 'root', '', 'excellenttaste');
$result = $conn->query("SELECT r.tafel, b.aantal, m.naam
...
WHERE g.gerechtcategoriencode = 'b4848' OR g.gerechtcategoriencode = 'c2965' OR g.gerechtcategoriencode = '8286f' OR g.gerechtcategoriencode = '7ff4f'
 OR g.gerechtcategoriencode = '69a66' OR g.gerechtcategoriencode = '4cdd0' OR g.gerechtcategoriencode = '14710'");
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <meta http-equiv="refresh" content="9; URL=http://localhost/excellenttaste/php/oberlijst.php">
    <meta charset="utf-8">
