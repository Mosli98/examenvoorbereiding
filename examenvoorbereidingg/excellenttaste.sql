...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 14 apr 2021 om 11:48
...
('14710', '715', 'voor de kids'),
('4cdd0', 'dd6', 'voorgerechten'),
('69a66', 'a73', 'niet voor kids'),
('7ff4f', 'f54', 'hapjes'),
...
('28699', 'henk', 611223344, 'henk@email.nl'),
('7eab0', 'hans', 611223355, 'hans@email.nl');
...
('0d6a9', '348b1', '6af', 7, 'chocolade taart'),
...
--
ALTER TABLE `gerechtsoorten`
  ADD CONSTRAINT `gerechtsoorten_ibfk_1` FOREIGN KEY (`gerechtcategoriencode`) REFERENCES `gerechtcategorien` (`gerechtcategoriencode`);

--
-- Beperkingen voor tabel `menuitems`
--
ALTER TABLE `menuitems`
  ADD CONSTRAINT `menuitems_ibfk_1` FOREIGN KEY (`gerechtsoortencode`) REFERENCES `gerechtsoorten` (`gerechtsoortencode`);

--
-- Beperkingen voor tabel `reserveringen`
--
ALTER TABLE `reserveringen`
  ADD CONSTRAINT `reserveringen_ibfk_1` FOREIGN KEY (`klantencode`) REFERENCES `klanten` (`klantencode`);
COMMIT;
