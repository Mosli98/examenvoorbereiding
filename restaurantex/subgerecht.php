...
<br>
  <div class="container">
      <div class="col-lg-12">
        <br><br>
      <h1 class="text-warning text-center" > Sub Gerechten (<a href="subgerechtadd.php?category_id=1"><i class="fas fa-plus"></i></a>)</h1>
      <br>
      <table class=" table table-striped table-hover table-bordered">
        ...
        <tr class="text-center">
          ...
          <td> <!-- &euro; --><?php echo $res['naam'];?> </td>
          <td>
            <a href="subgerechtedit.php?id=<?php echo $res['id'];?>"><i class="fas fa-edit"></i></a>
          </td>
          <td>
            <a href="subgerechtdelete.php?id=<?php echo $res['id'];?>" class="text-danger" onclick="confirm(' weet u dat zeker ?')"> <i class="fas fa-trash"></i></a>
