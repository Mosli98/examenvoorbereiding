  ...
  <div class="container">
      ...
      <table class=" table table-striped table-hover table-bordered">
        ...
        include_once "classdatabase.php";
            ...
            $records=$pdo->adminoberoverzicht();
        ...
        <tr class="text-center">
          ...
          <td> <button class="btn-danger"> <a href="deleteober.php?id= <?php echo $res['id']; ?>" class ="text-white">  Delete </a> </button> </td>
          <td> <button class="btn-white"> <a href="updateober.php?id=<?php echo $res['id']; ?>" calss="text-danger"> Update </a> </button> </td>
        </tr>
        <?php
          } 
        ?>
...
<br>
  <div class="container">
      <div class="col-lg-12">
        <br><br>
      <h1 class="text-warning text-center" > Ober toevoegen </h1>
      <br>
      <form action="addober.php" method="POST">
      <table class=" table table-striped table-hover table-bordered">
        <tr class="bg-dark text-white text-center">
