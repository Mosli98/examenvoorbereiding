...
<br>
  <div class="container">
      <div class="col-lg-12">
        <br><br>
      <h1 class="text-warning text-center" > Hoofd Groep Gerechten (<a href="gerechthoofdgroepadd.php?category_id=1"><i class="fas fa-plus"></i></a>)</h1>
      <br>
      <table class=" table table-striped table-hover table-bordered">
        ...
        include_once "classdatabase.php";
            ...
            $records=$pdo->gerechthoofdgroep();
            foreach($records as $res) {
        ?>
       
        <tr class="text-center">
          <td> <?php echo $res['code'];?> </td>
          <td> <!-- &euro; --><?php echo $res['naam'];?> </td>
          <td>
            <a href="gerechthoofdgroepedit.php?id=<?php echo $res['id'];?>"><i class="fas fa-edit"></i></a>
          </td>
          <td>
            <a href="gerechthoofdgroepdelete.php?id=<?php echo $res['id'];?>" class="text-danger" onclick="confirm(' weet u dat zeker ?')"> <i class="fas fa-trash"></i></a>
