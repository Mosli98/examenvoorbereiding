...
if(isset($_POST['submit'])){
  ...
  $password = $_POST['password'];
    ...
    $pdo->barmanupdate($id, $username);
    header('location:adminoverzichtbarman.php');
} 

$records= $pdo->selectbarman($id);
    ...
    <form method="POST" action="">
      <br><br><div class="card" style="color: #FFF;">
        <div class="card-header bg-dark">
          <h1 class="text-white"> Update barman</h1>
        </div>
        ...
        <input type="text" name="username" class="form-control" placeholder="password" value="<?php echo $password; ?>"> <br>
