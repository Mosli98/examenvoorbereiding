...
<br>
  ...
  <div class="container">
      <div class="col-lg-12">
        <br><br>
      <h1 class="text-warning text-center" > Barman overzicht</h1>
      <br>
      <table class=" table table-striped table-hover table-bordered">
        ...
        include_once "classdatabase.php";
            ...
            $records=$pdo->adminbarmanoverzicht();
        ...
        <tr class="text-center">
          ...
          <td> <button class="btn-danger"> <a href="deletebarman.php?id= <?php echo $res['id']; ?>" class ="text-white">  Delete </a> </button> </td>
          <td> <button class="btn-white"> <a href="updatebarman.php?id=<?php echo $res['id']; ?>" calss="text-danger"> Update </a> </button> </td>
        </tr>
        <?php
          } 
        ?>
...
<br>
  <div class="container">
      <div class="col-lg-12">
        <br><br>
      <h1 class="text-warning text-center" > Barman toevoegen </h1>
      <br>
      <form action="addbarman.php" method="POST">
      <table class=" table table-striped table-hover table-bordered">
        <tr class="bg-dark text-white text-center">
